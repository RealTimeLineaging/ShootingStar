...
public class ImageContrastTool extends JDialog implements ActionListener, ChangeListener {
	...
	public void setTicks(JSlider js) {
		...
		if (iUseStack == 1) {
			js.setMinorTickSpacing((int)((MAX16BIT+1)/16));
		    js.setMajorTickSpacing((int)((MAX16BIT+1)/8));
		}
		else {
			js.setMinorTickSpacing((int)((MAX8BIT+1)/16));
		    js.setMajorTickSpacing((int)((MAX8BIT+1)/8));
		}
