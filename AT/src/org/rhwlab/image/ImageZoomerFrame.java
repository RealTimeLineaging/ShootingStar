...
m_imagePanel.addKeyListener(iImgWin); //added to make zoom window respond to key events -AS 11/23/11
    ...
    public void mouseClicked(MouseEvent e)
    {
        ...
        {
            //m_imagePanel.zoomIn();
            //println("mouseClicked, button1, " + e.getX() + CS + e.getY());
        }
        else if(e.getButton() == MouseEvent.BUTTON3)
        {
            //m_imagePanel.zoomOut();
            //println("mouseClicked, button3, " + e.getX() + CS + e.getY());
        }
        //getPositionData(e.getX(), e.getY());
        getPositionData(e);
        adjustLayout();
    }
