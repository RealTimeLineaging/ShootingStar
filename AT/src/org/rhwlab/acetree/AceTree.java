...
//         p.add(iColorToggle);
    ...
    private void getCurrentCellParameters() {
        ...
        try {
        	...
        	Vector nuclei = (Vector)iNucleiMgr.getElementAt(time - 1);
...
////////////////////////////////////////////////////////////////////
    ...
    private void copyImage() {
        ...
        iw.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        iw.setAceTree(this);
        //iw.refreshDisplay(s);
...
// introduced to permit right click on tree to select end time of cell
	...
	public void controlCallback(Vector v) {
        ...
        if (ctrl.equals("InputCtrl1")) {
            ...
            try {
                ...
                v2 = (Vector)iNucleiMgr.getElementAt(requestedTime-1);
                haveTime = true;
	...
	private void doDaughterDisplayWork(Cell parent, Cell selectedDaughter) {
        ...
        Vector nuclei = (Vector)iNucleiMgr.getElementAt(iImageTime + iTimeInc - 1);
    ...
    public void setCurrentCell(Cell c, int time, int source) {
		...
		if(iImgWin!=null)
        	...
        	Vector nuclei1 = (Vector)iNucleiMgr.getElementAt(iImageTime + iTimeInc);
            Vector nuclei0 = (Vector)iNucleiMgr.getElementAt(iImageTime + iTimeInc - 1);
    ...
    */
    ...
    public void killCell(int x) {
    	...
    	Vector nuclei = (Vector)iNucleiMgr.getElementAt(currenttime);
...
*/
    ...
    private void debugShow(int testTime) {
        ...
        nuclei = (Vector)iNucleiMgr.getElementAt(testTime - 1);
        ...
        nuclei = (Vector)iNucleiMgr.getElementAt(testTime);
