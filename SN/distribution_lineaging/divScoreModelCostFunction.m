function [scores,splitscores,certainties,features]=divScoreModelCostFunction(esequence,i,t,candidates,candidate_times,trackingparameters,parameters)
...
for j=1:size(candidates,1)
    tripledata=calculateCellTripleVector(esequence{t},i,esequence{candidate_times(j,1)},candidates(j,1),esequence{candidate_times(j,2)},candidates(j,2),trackingparameters.anisotropyvector,trackingparameters.interval,parameters);
