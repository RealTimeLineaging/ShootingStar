function esequence=greedydeleteFPbranches(esequence,trackingparameters,parameters)
    ...
    for i=1:size(esequence{t}.finalpoints,1)
        ...
        if(esequence{t}.suc(i,2)~=-1&~esequence{t}.delete(i))
            ...
            [d1cand,d2cand,d1candt,d2candt,d1length,d2length,...
                ...
                = assembleBifurcationData( esequence,t,i,trackingparameters,count,parameters );
            ...
            if (trackingparameters.dotrack)
                ...
                if(predicted_class==0)
                    %other
                    FNtype=[FNtype;-1, -1];
                    [esequence,count] = processOtherBifurcation( esequence,t,i,splitscores_div,trackingparameters,count,parameters);
                else
