function esequence=greedyEndScore(esequence,trackingparameters,parameters)
   ...
   %hysteresis control loop, unused if no hysteresis;
    ...
    for i=1:size(esequence{t}.finalpoints,1)
        ...
        if(~isempty(esequence{t}.forwardcandidates{i})&&~esequence{t}.delete(i))
            ...
            [scores_div,splitscores_div,certainties_div]=trackingparameters.DivCostFunction(esequence,i,t,divcandidates,divcandidates_t, trackingparameters,parameters);
