function bestrange=vcalculateMaximalRange(planes,centerpoint,logodds,xycoverage, numcells,parameters)
...
%threshold=1;
threshold=getParameter('rangethreshold',numcells,centerpoint,parameters);
